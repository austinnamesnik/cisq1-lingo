...
public interface GameMapper {
    ...
    @Mapping(target = "hint", expression = "java(game.getLastRound().startRound().getHint())")
    ...
    @Mapping(target = "attempts", expression = "java(game.getLastRound().getAttempts())")
    @Mapping(target = "feedbacks", expression = "java(game.getLastRound().getFeedbackList())")
    @Mapping(target = "hint", expression = "java(game.getLastRound().getFeedbackList().get(game.getLastRound().getFeedbackList().size() - 1).giveHint().getHint())")
